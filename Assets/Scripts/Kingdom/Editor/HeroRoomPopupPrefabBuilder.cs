...
{
    /// <summary>
    /// HeroRoomPopup 프리팹 생성 유틸리티.
    /// </summary>
    public static class HeroRoomPopupPrefabBuilder
    {
        private const string PrefabPath = "Assets/Resources/UI/WorldMap/HeroRoomPopup.prefab";

        [MenuItem("Tools/Kingdom/Build HeroRoomPopup Prefab")]
        public static void Build()
        {
            ...
            GameObject root = new GameObject("HeroRoomPopup", typeof(RectTransform), typeof(CanvasRenderer), typeof(Image), typeof(HeroSelectionUI));
            ...
            Debug.Log($"[HeroRoomPopupPrefabBuilder] Prefab generated: {PrefabPath}");
        }
